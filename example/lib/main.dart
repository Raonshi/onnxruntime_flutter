...
class _MyAppState extends State<MyApp> {
  ...
  void initState() {
    super.initState();
    _version = OrtEnv.version;
    _nudenetTester = NudenetTester();
    _nudenetTester?.initModel();
  }
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                TextButton(
                    onPressed: () async {
                      await _nudenetTester?.inferenceTest();
                    },
                    child: const Text('NudeNet test')),
              ],
            ),
